...
if [[ "${PACKAGE:-0}" == "1" ]]; then
  ...
  if $is_macos; then
    ...
    "$VENV_PY" -m PyInstaller \
      ...
      --onefile \
      --collect-all tkinter \
      --add-data "src/sole_solutions/ui/images/bottomleft.png;sole_solutions/ui/images" \
      --add-data "src/sole_solutions/ui/images/bottomright.png;sole_solutions/ui/images" \
      --add-data "src/sole_solutions/ui/images/middleleft.png;sole_solutions/ui/images" \
      --add-data "src/sole_solutions/ui/images/middleright.png;sole_solutions/ui/images" \
      --add-data "src/sole_solutions/ui/images/topleft.png;sole_solutions/ui/images" \
      --add-data "src/sole_solutions/ui/images/topright.png;sole_solutions/ui/images" \
      --noconfirm \
      src/main.py
  else
